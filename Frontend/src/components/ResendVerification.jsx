          ...
          {cooldown > 0 && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
              <p className="text-sm text-yellow-700">
                You can request another verification email in {formatTime(cooldown)}
              </p>
            </div>
          )}
    ...
    >
      ...
      >
          ...
          >
            <div className="flex items-center">
              ...
              <span className="text-sm">
                Please wait {formatTime(cooldown)} before requesting another email
              </span>
            </div>
          </motion.div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              disabled={cooldown > 0}
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 disabled:opacity-50"
            />
          </div>
        ...
        <div className="mt-6 text-center space-y-3">
          <Link 
            to="/login" 
            className="block text-blue-600 hover:text-blue-800 font-semibold hover:underline transition duration-200"
          >
            Back to Login
          </Link>
          <Link 
            to="/signup" 
            className="block text-gray-600 hover:text-gray-800 hover:underline transition duration-200 text-sm"
          >
            Create New Account
          </Link>
        </div>
